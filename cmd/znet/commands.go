...
func Activate(ctx context.Context, configF *infra.ConfigFactory) error {
	...
	shellCmd.Env = append(os.Environ(),
		...
		"ZNET_ENV="+configF.EnvName,
		"ZNET_PROFILES="+strings.Join(configF.Profiles, ","),
		"ZNET_CORED_VERSION="+configF.CoredVersion,
		"ZNET_HOME="+configF.HomeDir,
		"ZNET_ROOT_DIR="+configF.RootDir,
	)
	if promptVar != "" {
